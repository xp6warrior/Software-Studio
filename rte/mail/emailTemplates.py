def get_email_template(template_id, full_name, item_id=None, item_type=None):
    return {
        ...
        6: (
            "Item expiring soon", 
            f"Hi {full_name},\n\nJust a heads up — your item (ID: {item_id}) is about to expire and will be archived soon.\n\nYou can extend its duration in your account if you'd like to keep it active! 😊"
        ),
        7: (
            "Item archived", 
            f"Hi {full_name},\n\nYour item (ID: {item_id}) has been archived.\n\nYou can restore or repost it anytime from your Back2U dashboard!"
        ),
        8: (
            "It’s a match!", 
