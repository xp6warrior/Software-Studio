...
def get_matching_fields_and_threshold(category: CategoryEnum):
    return {
        ...
        CategoryEnum.JEWELRY: (["type", "color", "size"], 1),
        CategoryEnum.ACCESSORIES: (["type", "color", "material"], 1),
        CategoryEnum.TRAVEL_ITEMS: (["type", "color", "size", "material"], 1),
        CategoryEnum.ELECTRONIC_DEVICES: (["type", "color", "material"], 1),
        CategoryEnum.CLOTHING: (["type", "color", "size", "material"], 1),
        CategoryEnum.OFFICE_ITEMS: (["type", "color", "size", "material"], 1),
        CategoryEnum.OTHER_ITEMS: (["type", "color", "size", "material"], 1),
    }[category]
